...
//import NotifyHOC from 'bt-react/barteh-message-box/notify-hoc';
...
class changePass extends Component {
    constructor() {
        super();
        this.state = {
            errors: { oldPass: true, newPass: true, rePass: true, captcha: true },
            userid: "",
            oldPass: "",
            newPass: "",
            rePass: "",
    ...
    handleChangePass = () => {
        ...
        if (this.state.newPass !== this.state.rePass) {
          ...
          this.props.messageService.notify('تکرار رمز عبور با رمز عبور برابر نیست');
            this
                .captcha
                .changesrc();
        ...
        doChangePassFn(this.state.oldPass, this.state.newPass, this.state.captchatext).then(r => {
            ...
            switch (r) {
                ...
                this.props.messageService.notify('پسورد با موفقیت ثبت گردید');
                    break;
                case 5:
                this.props.messageService.notify('ارتباط با سرور بر قرار نشد', "error");
                    break;
                case 2:
                this.props.messageService.notify('پسورد قبلی خود را بدرستی وارد کنید', "secondary");
                    break;
                case 13:
                this.props.messageService.notify('کاربر از سیستم خارج شده است', "secondary");
                    break;
                case 18:

                this.props.messageService.notify('پسورد از لحاظ امنیتی ضعیف می باشد', "secondary");

                    break;
                case 19:
                this.props.messageService.notify('کاربر دسترسی به سیستم ندارد', "error");
                    break;
                case 1:
                this.props.messageService.notify('کد امنیتی را به درستی وارد کنید', "secondary");
                    break;
            ...
            <form
                ...
                <Grid
                    ...
                    <Paper className={classes.papre}>
                        ...
                        <Typography className={classes.subheading} variant="subheading" gutterBottom align="center" color="textSecondary">
